<?php
  include 'admin/connection/dbconn.php';
...
<div class="container">
  <div class="row">
    <?php
      ...
      {
        $imgSrc="admin/upload/seminar/".$rows["images"];
    ?>
    <div class="col-xs-10 col-md-10 col-lg-10">
      ...
      <div class="card-block">
        ...
        <p class="card-text" class="paddin"><?php echo $rows["information"];?></p>
      </div>
      <div class="card-footer">
        <small class="text-muted"><?php echo $rows["guest"];?></small>
      </div>
    </div>
    </div>
    <?php
